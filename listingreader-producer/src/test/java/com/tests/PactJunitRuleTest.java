...
/**
 * @description Pact Junit Rule-Single Interaction Test of writing the PACT Test File
 */
public class PactJunitRuleTest {
    ...
    public void runTest(){
        ...
        String from="USD";
        String to="INR";
        ListingReaderResponse listingReaderResponse =ProxyApiController.retrieveExchangeValue(currencyExchange_mockProvider.getUrl(),from,to);
